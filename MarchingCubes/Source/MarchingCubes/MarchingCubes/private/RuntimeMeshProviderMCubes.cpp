...
void URuntimeMeshProviderMCubes::SetBoxRadius(const FVector& InRadius)
{
	FScopeLock Lock(&PropertySyncRoot);
	BoxRadius = InRadius;
...
UMaterialInterface* URuntimeMeshProviderMCubes::GetBoxMaterial() const
{
	FScopeLock Lock(&PropertySyncRoot);
	return Material;
}

void URuntimeMeshProviderMCubes::SetBoxMaterial(UMaterialInterface* InMaterial)
{
	FScopeLock Lock(&PropertySyncRoot);
	Material = InMaterial;
...
void URuntimeMeshProviderMCubes::Initialize()
{
...
FBoxSphereBounds URuntimeMeshProviderMCubes::GetBounds()
{
	return FBoxSphereBounds(FBox(-BoxRadius, BoxRadius));
}

bool URuntimeMeshProviderMCubes::GetSectionMeshForLOD(int32 LODIndex, int32 SectionId, FRuntimeMeshRenderableMeshData& MeshData)
...
FRuntimeMeshCollisionSettings URuntimeMeshProviderMCubes::GetCollisionSettings()
{
...
bool URuntimeMeshProviderMCubes::HasCollisionMesh()
{
	return true;
}

bool URuntimeMeshProviderMCubes::GetCollisionMesh(FRuntimeMeshCollisionData& CollisionData)
{
...
bool URuntimeMeshProviderMCubes::IsThreadSafe()
{
	return true;
}
