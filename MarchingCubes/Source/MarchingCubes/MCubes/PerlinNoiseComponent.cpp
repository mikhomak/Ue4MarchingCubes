...
// Called every frame
void UPerlinNoiseComponent::TickComponent(float DeltaTime, ELevelTick TickType,
...
void UPerlinNoiseComponent::SetupOptions(float Frequency_, float Lacunarity_,
                                         qualities::PerlinNoiseQuality NoiseQuality_, int OctaveCount_,
                                         float Persistence_, int Seed_)
{
